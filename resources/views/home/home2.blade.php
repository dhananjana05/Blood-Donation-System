              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p style="color: blue; font-size: 80px;">{{ $count }}</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-cube-alt"></i>
                    <h4>Total   BlodDonors    .   </h4>
                    <p  style="color: blue; font-size: 80px;">{{ $donor }}</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-images"></i>
                    <h4>Registered Hospital     </h4>
                    <p style="color: blue; font-size: 80px;">30 </p>
                  </div>
                </div>
              </div>
            </div>
